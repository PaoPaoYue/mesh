...
Common labels
*/}}
{{- define "mesh-proxy.labels" -}}
helm.sh/chart: {{ include "mesh-proxy.chart" . }}
{{ include "mesh-proxy.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "mesh-proxy.selectorLabels" -}}
app.kubernetes.io/name: {{ include "mesh-proxy.name" . }}
