...
import com.github.paopaoyue.mesh.canvas_application.service.ICanvas-applicationService;
import com.google.protobuf.Any;

@ServiceServerStub(serviceName = "canvas-application")
public class Canvas-applicationServerStub implements IServerStub {

    private static final String SERVICE_NAME = "canvas-application";

    private ICanvas-applicationService service;
